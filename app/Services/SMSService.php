...
class SMSService
{
            ...
            $response = $client->request(
                ...
                [
                    RequestOptions::JSON => [
                        ...
                        "to" => $phone,
                        "from" => "N-Alert",
                        "sms" => "Your Faveremit confirmation code is " . $otp . ". It expires in 30min",
                        "type" => "plain",
                        "channel" => "dnd",
                    ],
                ]
    ...
    public static function sendSMS($phone, $message)
    {
        ...
        $curl = curl_init();
        $data = array(
            "api_key" => "TLK5cz8X7B7dqFLMNy0ZyFOMOvs7JPghhUkm4yeUbx8Ybg54bh1eOagJtEyf7g", "to" => $phone,  "from" => "Faveremit",
